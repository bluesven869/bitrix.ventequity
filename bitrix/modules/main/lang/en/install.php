...
$MESS["INS_TITLE1"] = "<font class=\"ventequitytitle\">Bitrix Site Manager #VERS#</font> <font class=\"install\">Installation</font>";
...
$MESS["SC_VMBITRIX"] = "<a href=\"http://www.ventequitysoft.com/products/virtual_appliance/\" target=\"_blank\">Server environment</a>";
...
$MESS["SC_WEBSERVER_VER_ER"] = "Your web-server version does not meet the Ventequity requirements";
$MESS["SC_WEBSERVER_VER_NONE"] = "Cannot determine your web-server version";
$MESS["SC_PHP_VER_ER"] = "Your PHP version does not meet the Ventequity requirements";
...
$MESS["SC_FBITRIX_NOWRITE"] = "Folder /ventequity/ is inaccessible for writing and/or reading";
...
$MESS["INS_DATABASE_MY_DESC"] = "Database name where Ventequity will be installed";
...
$MESS["GOTO_BITRIX"] = "Go to Ventequity web site";
...
$MESS["GOTO_IF_ERROR"] = "Should you have any problems installing \"Bitrix Site Manager\", please do not hesitate to contact the <a href=\"http://www.ventequitysoft.com/support/\" target=\"_blank\">customer support service</a>. Highly qualified specialists of the <a href=\"http://www.ventequitysoft.com/\" target=\"_blank\">\"Bitrix\"</a> company are always at your service. ";
...
$MESS["IS1_BIT_LOZ"] = "Thank you for choosing Ventequity Site Manager";
$MESS["COPYRIGHT"] = "Copyright &copy; 2001-#CURRENT_YEAR# Bitrix, Inc.";
$MESS["SUPPORT"] = "<a href=\"https://www.ventequity24.com/\" target=\"_blank\">www.ventequity24.com</a> <span class=\"instal-footer-separator\"></span> <a href=\"https://helpdesk.ventequity24.com/\" target=\"_blank\">Support</a>";
$MESS["SUPPORT_README"] = "<a href=\"/readme.html\" target=\"_blank\">Installation instructions</a> <span class=\"instal-footer-separator\"></span> ";
$MESS["FIRST_PAGE"] = "<font class=\"text\">The setup wizard will test your software compatibility and install Ventequity Site Manager.<br><br>After the installation is complete, you can start using your site.<br><br>Using the SiteUpdate system you can update your copy and use the up-to-date version of Ventequity Site Manager.<br><br>You can get more details on Ventequity Site Manager here: <a href=\"http://www.ventequitysoft.com/\" target=\"_blank\">http://www.ventequitysoft.com</a><br><br>Should you have any questions on the installation process, please do not hesitate to contact the <a href=\"http://www.ventequitysoft.com/support/\" target=\"_blank\">Bitrix Helpdesk department</a>.</font>";
$MESS["GO_TO_CONTROL"] = "Manage site";
$MESS["GO_TO_REGISTER"] = "Register product";
$MESS["GO_TO_REGISTER_DESCR"] = "Registering your copy of Ventequity Site Manager entitles you to:<ul><li>download and install the latest updates of the system;</li><li>send requests to the Ventequity helpdesk service, which will allow you to obtain timely advices on any question regarding the system installation and functioning;</li><li>activate your own account on the Ventequity private forum. This will enable you to discuss questions with other users, Ventequity partners as well as the Helpdesk staff.</li></ul>";
...
$MESS["SC_DB_VERS_MYSQL_ER"] = "Your MySql version does not meet the Ventequity requirements";
...
$MESS["INS_DB_NEW"] = "New";
$MESS["GOTO_BITRIX_NOTES"] = "Go to <a href=\"http://www.ventequitysoft.com/\" target=\"_blank\">Ventequity web site</a> (<a href=\"http://www.ventequitysoft.com/\" target=\"_blank\">http://www.ventequitysoft.com</a>) and learn the latest news on the product. Please feel free to ask questions on Ventequity Site Manager at our <a href=\"http://www.ventequitysoft.com/support/forum/index.php?\" target=\"_blank\">forum</a> or use the <a href=\"http://www.ventequitysoft.com/support/\" target=\"_blank\">automated Helpdesk service</a>.";
$MESS["POWERED_BY"] = "Powered by \"Ventequity\"";
...
$MESS["INST_JAVASCRIPT_DISABLED"] = "JavaScript support is required to install Ventequity Site Manager. Apparently, JavaScript is not supported by browser or disabled. Change your browser settings and <a href=\"\">try again</a>.";
$MESS["INS_UTF_PARAMS"] = "UTF-8 Installation of Ventequity Site Manager";
$MESS["INST_UTF8_RECOMENDATION1"] = "UTF-8 installation of Ventequity Site Manager requires <b>mbstring</b> library with parameters <b>mbstring.func_overload=2</b> and <b>default_charset=UTF-8</b>.";
$MESS["ERR_MBSTRING_EXISTS1"] = "Non UTF-8 installation of Ventequity Site Manager requires that you set <b>mbstring.func_overload</b> parameter to 0 (zero). Otherwise, install Ventequity Site Manager in UTF-8.";
...
$MESS["ACT_KEY_REQUEST_ERROR"] = "An error occurred while requesting a license key. Please contact our <a href='http://www.ventequitysoft.com/support/index.php'>Helpdesk</a>.";
