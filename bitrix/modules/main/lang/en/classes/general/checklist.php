...
$MESS["CL_QH0020_DESC"] = "Bitrix Web Environment (Windows or Linux), or Thurly Virtual Appliance has been used to configure and optimize the server software and configuration.";
...
$MESS["CL_QP0010_DESC"] = "Bitrix Web Environment (Windows or Linux), or Thurly Virtual Appliance is used for maximum performance. The project uses two-tier frontend-backend configuration.";
...
$MESS["CL_VMBITRIX_ACTUAL"] = "Your version of Thurly Virtual Appliance is up-to-date.";
$MESS["CL_VMBITRIX_NOT_ACTUAL"] = "Your version of Thurly Virtual Appliance needs to be updated.";
