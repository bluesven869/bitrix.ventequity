	...
	<div class="crm-detail-lead-wrap">
		...
		<div class="crm-instant-editor-fld-block">
			<div class="crm-detail-comments-text" style="padding-left: 0;">
				...
				<p><?= htmlspecialcharsbx(GetMessage('CRM_EXCH1C_COMMENT_FREE_P2')) ?><a href="http://www.1c-thurly.ru/products/intranet/features/crm/1c.php"><?= htmlspecialcharsbx(GetMessage('CRM_EXCH1C_BITRIX24_LINK1')) ?></a>.</p>
